...
export default function ContactTable({
  ...
  function filterContacts(): Contact[] {
    ...
    if (!showActive || nameFilter !== null || cityFilter !== null) {
      ...
      filteredContacts = filteredContacts.filter(({ isActive, name, city }) => {
  ...
  function sortContacts(): Contact[] {
    const sortedContacts =
      filteredContacts !== null ? filteredContacts : contacts;
    if (sortColumn !== null) {
  ...
  return (
    <table cellPadding='0' cellSpacing='0' className='contact-table'>
            ...
            <div>
              <div>
                ...
                <button
                  ...
                  onClick={() => setFilteredContacts(filterContacts())}
                >
                  <p>FILTER</p>
                </button>
              </div>
      ...
      <tbody>
        {sortContacts().map((contact, index, { length }) => {
